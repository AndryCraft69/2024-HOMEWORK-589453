...
public class IOSimulatorTest {
	...
	public void test_PartitaCasuale() {		
		...
		DiaDia simulazione = new DiaDia(Labirinto.newBuilder().getLabirinto(), ioSimulator);
		simulazione.gioca();
		...
		assertEquals("vai aiuto prendi posa fine guarda regala saluta interagisci ", elencoMessaggiStampati.get(1));
