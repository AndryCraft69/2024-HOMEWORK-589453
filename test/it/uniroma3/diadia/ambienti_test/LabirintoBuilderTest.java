...
public class LabirintoBuilderTest {
	...
	public void testBilocale() {
		...
		assertEquals("[sud]", bilocale.getStanzaFinale().getDirezioni().toString());
	}
	...
	public void testPiuDiQuattroAdiacenti() {
		...
		//assertEquals(mappa, maze.getStanzaIniziale().getMapStanzeAdiacenti()); giusto, ma l'ordine di stampa è diverso
	}
